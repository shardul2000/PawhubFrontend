...
export default function Market(props) {
	...
	useEffect(() => {
		if (city !== '') {
			axios
				.get(
					`${process.env.REACT_APP_SERVER}/api/market/getListingByLocation/${city}` ,
					{
						headers: {
			...
			axios
				.get(
					`${process.env.REACT_APP_SERVER}/api/market/getAllListings`,
					{
						headers: {
							'Content-Type': 'application/json',
						},
	...
	const drawer = (
		<div className="container">
			...
			<Divider />
			<List>
				<ListSubheader>Post Listing</ListSubheader>
				<Link to="/postAd">
			...
			<List>
				<ListSubheader>Item Categories</ListSubheader>
				{['Pet toys', 'Pet Furniture', 'Cages', 'Beauty'].map((text, index) => (
			...
			<Divider />
			<ListSubheader>Filter by pet</ListSubheader>
			<List>
				{['Dogs', 'Cats', 'Birds', 'Fish'].map((text, index) => (
					<ListItem key={text} disablePadding>
						<ListItemButton>
							<ListItemText primary={text} />
						</ListItemButton>
